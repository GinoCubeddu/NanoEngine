...
namespace NanoEngine.Testing.Assets
{
    class plane : Entity, ISATColidable
    {
        ...
        public override void Initilise()
        {
            ...
            leftWing.Add(new Vector2(-121, -34));
            leftWing.Add(new Vector2(-19, -28));
            leftWing.Add(new Vector2(-19, -67));
            leftWing.Add(new Vector2(-121, -57));
            AddPoints(leftWing);

            IList<Vector2> rightWing = new List<Vector2>();
            rightWing.Add(new Vector2(17, -28));
            rightWing.Add(new Vector2(119, -34));
            rightWing.Add(new Vector2(119, -57));
            rightWing.Add(new Vector2(17, -67));
            AddPoints(rightWing);
